...
if __name__ == '__main__':
    ...
    # parser.add_argument('--image_size', type=int, default=256,
    #                     help='size for image after processing')
    parser.add_argument('--image_dir', type=str, default= 'D:/专业课/上/数据科学开源工具/7_Pytorch_image_caption(NIC)/data2/image_datang',
                        help='directory for train images')
    parser.add_argument('--output_dir', type=str, default='D:/专业课/上/数据科学开源工具/7_Pytorch_image_caption(NIC)/data2/image_datang_resized',
                        help='directory for saving resized images')
    parser.add_argument('--image_size', type=int, default=256,
                        help='size for image after processing')
